...
<img width="40%" height="58%" src="https://github.com/Elena-Chikara/Banking-churn-prediction-for-marketing-purposes/blob/Elena-Chikara-README-file/plots_and_tables/income_category_bi.png"></a>
 ...
 <p align="center">
<a><img width="45%" height="58%" src="https://github.com/Elena-Chikara/Banking-churn-prediction-for-marketing-purposes/blob/Elena-Chikara-README-file/plots_and_tables/Total_Revolving_Bal_bi.PNG"></a>
<img width="45%" height="58%" src="https://github.com/Elena-Chikara/Banking-churn-prediction-for-marketing-purposes/blob/Elena-Chikara-README-file/plots_and_tables/Avg_Utilization_Ration_bi.PNG"></a>
</p>
<p align="justify">These box-plots only confirm what was stated before this. The greater the 'Avg_Utilisation_Ratio' and 'Total_Revolving_Bal', the smaller the chances for the client to leave.</p><br/>
...
## Conclusion
 <p>
<ul>
  <li align="justify">Having in mind the very unbalanced observed dataset that is used in the project, the produced result is exceptional.</li>
